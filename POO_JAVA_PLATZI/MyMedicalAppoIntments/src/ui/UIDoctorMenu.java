...
public class UIDoctorMenu {
    ...
    private static void showAddAvailableAppointments(){
        ...
        do {
            ...
            if (response > 0 && response <  4) {
                ...
                System.out.println("Insert the date available : [DD/MM/AAAA]");
                ...
                String time = " ";
                do {
                    System.out.println("Inserte the time available for date " + date + "[16:00");
                    time = sc.nextLine();
    ...
    private static void checkDoctorAvailableAppointments (Doctor doctor){
        if (doctor.getAvailableAppointments().size() > 0 && !doctorAvailableAppointment.contains(doctor)){
